...
- Create Angular project with ng: `ng new salesdatepredictionproject.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`salesdatepredictionproject.client.esproj`).
